...
void lookat(const Furvec3 eye, const Furvec3 center, const Furvec3 up) {
    ...
    // Worst matrix structure in the history
    vector<float> MtransposeData;
    MtransposeData.push_back(l.x);
    MtransposeData.push_back(l.y);
    MtransposeData.push_back(l.z);
    MtransposeData.push_back(0);

    MtransposeData.push_back(m.x);
    MtransposeData.push_back(m.y);
    MtransposeData.push_back(m.z);
    MtransposeData.push_back(0);

    MtransposeData.push_back(n.x);
    MtransposeData.push_back(n.y);
    MtransposeData.push_back(n.z);
    MtransposeData.push_back(0);

    MtransposeData.push_back(0);
    MtransposeData.push_back(0);
    MtransposeData.push_back(0);
    MtransposeData.push_back(1);

    Mtranspose.addData(MtransposeData);
    ...
    Cdata.push_back(0);
    Cdata.push_back(0);
    Cdata.push_back(-center.x);

    Cdata.push_back(0);
    Cdata.push_back(1);
    Cdata.push_back(0);
    Cdata.push_back(-center.y);

    Cdata.push_back(0);
    Cdata.push_back(0);
    Cdata.push_back(1);
    Cdata.push_back(-center.z);
...
void perspective(const double f) {
    vector<float> perspectiveData;
    // its not funny anymore
    perspectiveData.push_back(1);
    perspectiveData.push_back(0);
    perspectiveData.push_back(0);
    perspectiveData.push_back(0);
    ...
    perspectiveData.push_back(0);
    perspectiveData.push_back(0);
    perspectiveData.push_back(-1/f);
    perspectiveData.push_back(1);

    Perspective.addData(perspectiveData);
}

void viewport(const int x, const int y, const int w, const int h) {
    vector<float> viewportData;
    // its not funny anymore
    viewportData.push_back(w/2.);
    viewportData.push_back(0);
    viewportData.push_back(0);
    viewportData.push_back(x+w/2.);

    viewportData.push_back(0);
    viewportData.push_back(h/2.);
    viewportData.push_back(0);
    viewportData.push_back(y+h/2.);

    viewportData.push_back(0);
    viewportData.push_back(0);
    viewportData.push_back(1);
    viewportData.push_back(0);
...
int main()
{
    ...
    Furvec3 eye(-1,0,2); // camera position
    Furvec3 center(0,0,0); // camera direction
    Furvec3 up(0,1,0); // camera up vector
    ...
    {
        Furvec3 screen_coords[3];
        float world_z[3];

        for (int j : {0, 1, 2}) {
            int idx = (j == 0) ? faces[i].x - 1 : (j == 1) ? faces[i].y - 1 : faces[i].z - 1;
            Furvec3 v = vertices[idx];

            Furvec3 temp = multiply_with_w(ModelView, v);
            temp = multiply_with_w(Perspective, temp);
            screen_coords[j] = multiply_with_w(ViewPort, temp);

            world_z[j] = temp.z;
        }

        TGAColor randomColor = {(uint8_t)(rand() % 255), (uint8_t)(rand() % 255), (uint8_t)(rand() % 255), 255};
        triangle(screen_coords[0].x, screen_coords[0].y, world_z[0],
                 screen_coords[1].x, screen_coords[1].y, world_z[1],
                 screen_coords[2].x, screen_coords[2].y, world_z[2],
                 depthbuffer, framebuffer, randomColor);
